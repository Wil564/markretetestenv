...
const contacts = [
  {
    ...
    phone: "786-672-3073",
    email: "Abel.markrete@gmail.com",
    phoneHref: "tel:7866723073",
    emailHref: "mailto:Abel.markrete@gmail.com",
  },
  {
    name: "Ana Alvarez",
    role: "International Sales Director",
    phone: null,
    email: "Ana.markrete@gmail.com",
    phoneHref: null,
    emailHref: "mailto:Ana.markrete@gmail.com",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="section-dark pt-32 pb-20 relative overflow-hidden">
        <span className="bg-number bg-number-light right-0 top-0 translate-x-1/4 -translate-y-1/4">CON</span>
