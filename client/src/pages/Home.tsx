    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#007b32] py-4">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-8 text-white text-sm font-heading font-600 tracking-wider" style={{width: '1300px'}}>
            <span>✓ Approved in Miami-Dade County</span>
            <span className="hidden sm:block w-px h-4 bg-white/30" />
            <span>✓ Strictest Building Codes in the U.S.</span>
            <span className="hidden sm:block w-px h-4 bg-white/30" />
            <span>✓ Signed & Sealed Engineering Included</span>
            <span className="hidden sm:block w-px h-4 bg-white/30" />
            <span>✓ Compatible with Pitched & Flat Roofs</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {highlights.map((item, i) => (
              <div key={item.title} className="fade-in-up" style={{ transitionDelay: `${i * 0.15}s` }}>
