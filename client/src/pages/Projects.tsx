...
const LUXURY_HOME_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663540068356/Y2YKXFmQVWeuToqwQKmxx2/luxury-home-cKunxaTDjU9LuPb4VzzjFw.webp";
const HERO_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663540068356/Y2YKXFmQVWeuToqwQKmxx2/hero-roof-jtCis8NzPVuBi9AvTJXcoN.webp";

// Placeholder project entries — client to provide actual project list
const projects = [
  {
    id: 1,
    name: "Miami-Dade Luxury Residence",
    location: "Miami-Dade County, FL",
    type: "Luxury Residential",
    style: "Mediterranean Pitched",
    description: "Custom luxury home featuring a pitched Mediterranean-style concrete roof. Designed to meet Miami-Dade's stringent building codes while preserving the architectural character of the neighborhood.",
    features: ["Pitched roof design", "R-30+ insulation", "Signed & sealed engineering"],
    image: LUXURY_HOME_IMG,
  },
  {
    id: 2,
    name: "South Florida Coastal Home",
    location: "South Florida",
    type: "Coastal Residential",
    style: "Contemporary Flat",
    description: "Modern coastal home with a flat concrete roof system. The MARkrete system provided the structural performance required for coastal hurricane exposure while enabling a clean, contemporary aesthetic.",
    features: ["Flat roof design", "60-ft span capability", "Cat 5 hurricane rated"],
    image: HERO_IMG,
  },
  {
    id: 3,
    name: "Caribbean Island Residence",
    location: "The Caribbean",
    type: "Island Residential",
    style: "Pitched Coastal",
    description: "Island home built to withstand the most extreme coastal weather conditions. The MARkrete system was selected for its proven performance in hurricane-prone environments and its compatibility with traditional island architecture.",
    features: ["Hurricane resistant", "No maintenance required", "100+ year lifespan"],
    image: LUXURY_HOME_IMG,
  },
  {
    id: 4,
    name: "Miami Custom Home",
    location: "Miami, FL",
    type: "Custom Residential",
    style: "Modern Flat",
    description: "Contemporary custom home in Miami featuring a modern flat concrete roof. The project demonstrates MARkrete's ability to integrate with modern architectural styles while delivering superior structural performance.",
    features: ["Modern design", "Energy efficient", "Insurance savings"],
    image: HERO_IMG,
  },
];
