        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              A patented insulated reinforced concrete roof system designed for hurricane-prone regions.
            </p>
            <div className="flex items-center gap-2">
              <span className="text-xs font-heading tracking-widest uppercase text-gray-500">U.S. Patent</span>
              <a
                href="https://patents.google.com/patent/US10196818"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#007b32] text-xs font-heading tracking-wider hover:text-[#00a844] transition-colors flex items-center gap-1"
              >
                #10196818 <ExternalLink size={10} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <p className="text-white text-sm font-heading font-600 mb-1">Abel Alonso</p>
                ...
                <a href="mailto:Abel.markrete@gmail.com" className="flex items-center gap-2 text-gray-400 text-sm hover:text-white transition-colors mt-1">
                  ...
                  Abel.markrete@gmail.com
                </a>
              </li>
              <li className="pt-2 border-t border-white/10">
                <p className="text-white text-sm font-heading font-600 mb-1">Ana Alvarez</p>
                <p className="text-gray-500 text-xs mb-1">International Sales Director</p>
                <a href="mailto:Ana.markrete@gmail.com" className="flex items-center gap-2 text-gray-400 text-sm hover:text-white transition-colors">
                  <Mail size={14} className="text-[#007b32]" />
                  Ana.markrete@gmail.com
                </a>
              </li>
            </ul>
          </div>
